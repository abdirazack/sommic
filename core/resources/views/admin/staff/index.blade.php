                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif ($staff->designation == 2)
                                                ...
                                                <span class="fw-bold text--info">@lang('Customer Service')</span>
                                            @elseif ($staff->designation == 3)
                                            
                                                <span class="fw-bold text--info">@lang('Accounting')</span>
                                            @else
                                                <span class="fw-bold text--info">@lang('Teller')</span>
    ...
    <div class="btn-group">
        <button class="btn btn-outline--primary dropdown-toggle" data-bs-toggle="dropdown" type="button">
            @if (request()->designation == 'manager')
                @lang('Manager')
            @elseif(request()->designation == 'teller')
                @lang('Teller')
            @elseif(request()->designation == 'accounting')
                @lang('Accounting')
            @elseif(request()->designation == 'customer_service')
        ...
        <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['designation' => 'teller']) }}">@lang('Teller')</a></li>
            <li><a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['designation' => 'accounting']) }}">@lang('Accounting')</a></li>
            <li><a class="dropdown-item" href="{{ request()->fullUrlWithQuery(['designation' => 'customer_service']) }}">@lang('Customer Service')</a></li>
        </ul>
    </div>
