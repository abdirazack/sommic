...
@section('panel')
    <div class="d-flex gap-3 mb-4 flex-wrap">
        <div class="flex-fill">
            <x-widget style="2" color="primary" title="Account Number | Account Type" value="{{ @$account->account_number }} | Joint {{ @$account->AccountType->name }}" icon="la la-user" icon_style="solid" />
        </div>
