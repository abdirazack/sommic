...
@section('panel')
    <div class="row gy-4">
            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <span class="fw-bold">@lang('Financing Number')</span>
        ...
        <div class="col-xl-8 mb-30">
            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="card-title border-bottom pb-2">@lang('Financing Form Submitted by User')</h5>
                    <x-view-form-data :data="$loan->application_form"></x-view-form-data>

                    @if ($loan->status == Status::LOAN_PENDING)
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <button class="btn btn-outline--success confirmationBtn" data-action="{{ route('admin.loan.approve', $loan->id) }}" data-question="@lang('Are you sure to approve this Financing?')">
