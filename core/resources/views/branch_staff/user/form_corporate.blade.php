                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-sm-4">
                                <div class="form-group">
                                    <label for="name">@lang('Organization Name')</label>
                            ...
                            <div class="col-xl-4 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="organization_type" id="organization_type" required>
                                        ...
                                        <option value="1">@lang('Sole Proprietorship')</option>
                                        <option value="2">@lang('Partnership/Company')</option>
                                        <option value="3">@lang('Community Organization')</option>
                                        <option value="4">@lang('NGO')</option>
                                        <option value="5">@lang('Utilies Company')</option>
                                        <option value="6">@lang('Educational Institution')</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-xl-4 col-sm-4">
                                <div class="form-group">
                                    <label for="establishment_date">@lang('Establishment Date')</label>
                                    <input class="form-control" name="establishment_date" type="date" id="establishment_date" required>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="region" type="text" id="region" required>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group ">
                                        <select class="input-group-text mobile-code" name="mobile-code" id="mobile-code" required>
                                            @foreach ($countries as $key => $country)
                                                <option value="{{ $country->dial_code }}">{{ "+".$country->dial_code }}</option>
                                            @endforeach
                                        </select>
                                        <input class="form-control" name="mobile" type="number" id="mobile" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-sm-12">
                                <div class="form-group">
                                    <label for="organization_profile_scan">@lang('Organization Profile Scan')</label>
                                    <input class="form-control" id="organization_profile_scan" name="organization_profile_scan" type="file" accept=".png, .jpg, .jpeg, .pdf" id="organization_profile_scan" required>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-sm-4">
                            <div class="form-group">
                                ...
                                <select name="doc_type" class="form-control" id="doc_type" required>
                                    ...
                                    <option value="7">@lang('Organization Certificate')</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-sm-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="doc_expiry" type="date" id="doc_expiry" required>
                            </div>
                        </div>
    ...
    <script>
        ...
        (function($) {
            ...
            $('#country').change(function() {
                ...
                $(`#mobile-code option[value='${mobileCode}']`).prop('selected', true);
            });

            let dialCode = $('#country :selected').data('mobile_code');
            ...
            $('#organization_type').on('change', function () {
                if($(this).val() == 1){
                    ...
                    $('.person :first .nok').show();
                    $('.person :first .nok :input').attr({'disabled': false, 'required': true});
                    
                    $(".person:not(:first) :input").attr({'disabled': true, 'required': false});
                }else{
                    $('#clone').attr('disabled', false);
                    $(`.person .nok`).hide();
                    $(`.person .nok :input`).attr({'disabled': true, 'required': false});
                    $(".person:not(:first) :input").attr({'disabled': false, 'required': true});
                }
            ...
            $('#clone').on('click', function(e) {
                if(ind <= 5){
                    ...
                    if(ind > 1){
                        $('html, body').animate({
                            scrollTop: $(`#person_${ind}`).offset().top
                        }, 1000);
                    }
