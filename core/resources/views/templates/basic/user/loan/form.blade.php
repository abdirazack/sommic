                ...
                <div class="card custom--card">
                    <div class="card-body">
                        <h5 class="text-center">
                            @lang('You are aplying to take financing')
                        </h5>
                        <p class="text-center text--danger">(@lang('Be Sure Before Confirm'))</p>

                        <ul class="caption-list-two">
                            <li>
                                <span class="caption">@lang('Product Name')</span>
                                <span class="value">@lang($plan->name)</span>
                            </li>

                            <li>
                                <span class="caption">@lang('Financing Amount')</span>
...
@push('bottom-menu')
    <li><a href="{{ route('user.loan.plans') }}">@lang('Financing Products')</a></li>
