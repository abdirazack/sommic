...
@section('panel')
    ...
    <div class="row gy-4">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget style=2 bg="white" color="indigo" icon="las la-hand-holding-usd" title="Running Financing" value="{{ $widget['total_running_loan'] }}" link="{{ route('admin.loan.running') }}" icon_style="solid" overlay_icon=0 />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget style=2 bg="white" color="2" icon="las la-hand-holding-usd" title="Pending Financing" value="{{ $widget['total_pending_loan'] }}" link="{{ route('admin.loan.pending') }}" icon_style="solid" overlay_icon=0 />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget style=2 bg="white" color="5" icon="las la-hand-holding-usd" title="Due Financing" value="{{ $widget['total_due_loan'] }}" link="{{ route('admin.loan.due') }}" icon_style="solid" overlay_icon=0 />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget style=2 bg="white" color="success" icon="las la-hand-holding-usd" title="Paid Financing" value="{{ $widget['total_paid_loan'] }}" link="{{ route('admin.loan.paid') }}" icon_style="solid" overlay_icon=0 />
        </div>
