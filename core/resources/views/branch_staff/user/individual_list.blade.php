                            ...
                            <tbody>
                                @forelse($accounts as $account)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge--{{ @$status[@$account->status]['badge'] }}">{{ @$status[@$account->status]['label'] }}</span>
                                        </td>
                                        ...
                                        <td>
                                            @if ($staff->designation == Status::ROLE_CUSTOMER_SERVICE)
                                                <a class="btn btn-sm btn-outline--primary" href="{{ route('staff.account.edit', $account->id) }}">
                                                    <i class="las la-edit"></i>@lang('Edit')
                                                </a>
                                            @endif

                                            <a class="btn btn-sm btn-outline--info" href="{{ route('staff.account.detail.individual', $account->account_number) }}">
