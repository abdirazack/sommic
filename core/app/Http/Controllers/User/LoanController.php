...
class LoanController extends Controller {
    ...
    public function confirm(Request $request) {
        ...
        $adminNotification->title     = 'New Financing request';
        $adminNotification->click_url = urlPath('admin.loan.index') . '?search=' . $loan->loan_number;
        $adminNotification->save();

        session()->forget('loan');

        $notify[] = ['success', 'Financing application submitted successfully'];
    ...
    public function installments($loanNumber) {
        ...
        $pageTitle    = 'Financing Installments';
