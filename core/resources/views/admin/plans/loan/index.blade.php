                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                ...
                                                @if ($plan->status)
                                                    <button type="button" data-action="{{ route('admin.plans.loan.status', $plan->id) }}" data-question="@lang('Are you sure to disable this Product?')" class="btn btn-sm confirmationBtn btn-outline--danger">
                                                        <i class="la la-la la-eye-slash"></i>@lang('Disable')
                                                    </button>
                                                @else
                                                    <button type="button" data-action="{{ route('admin.plans.loan.status', $plan->id) }}" data-question="@lang('Are you sure to enable this Product?')" class="btn btn-sm confirmationBtn btn-outline--success">
