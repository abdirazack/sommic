...
class BranchStaffController extends Controller {
    ...
    public function index() {
        ...
        if (request()->has('designation')) {
            ...
            switch($designation){
                case 'manager':
                    $designation = STATUS::ROLE_MANAGER;
                    break;
                case 'teller':
                    $designation = STATUS::ROLE_TELLER;
                    break;
                case 'customer_service':
                    $designation = STATUS::ROLE_CUSTOMER_SERVICE;
                    break;
                case 'accounting':
                    $designation = STATUS::ROLE_ACCOUNTING;
                    break;
            }
    ...
    public function save(Request $request, $id = 0) {
        ...
        $staff->account_number     = $staff->account_number ?? generateAccountNumber();
    ...
    private function validation($request, $id) {
        $request->validate([
            ...
            'designation' => 'required|in:0,1,2,3',
