                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="designation" required>
                            ...
                            <option value="{{ Status::ROLE_TELLER }}" @selected(@$staff->designation == Status::ROLE_TELLER)>@lang('Teller')</option>
                            <option value="{{ Status::ROLE_CUSTOMER_SERVICE }}" @selected(@$staff->designation == Status::ROLE_CUSTOMER_SERVICE)>@lang('Customer Service')</option>
                            <option value="{{ Status::ROLE_ACCOUNTING }}" @selected(@$staff->designation == Status::ROLE_ACCOUNTING)>@lang('Accounting')</option>
                        </select>
                    </div>
                </div>
